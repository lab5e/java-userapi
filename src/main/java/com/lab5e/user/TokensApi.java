...
import com.lab5e.user.model.AnAPIToken;
...
public class TokensApi {
     ...
     */
    public okhttp3.Call updateTokenCall(String token, AnAPIToken body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTokenValidateBeforeCall(String token, AnAPIToken body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Token updateToken(String token, AnAPIToken body) throws ApiException {
     ...
     */
    public ApiResponse<Token> updateTokenWithHttpInfo(String token, AnAPIToken body) throws ApiException {
     ...
     */
    public okhttp3.Call updateTokenAsync(String token, AnAPIToken body, final ApiCallback<Token> _callback) throws ApiException {

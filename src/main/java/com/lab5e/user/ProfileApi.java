...
public class ProfileApi {
    ...
    /**
     * Build call for userGetUserProfile
     ...
     */
    public okhttp3.Call userGetUserProfileCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call userGetUserProfileValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = userGetUserProfileCall(_callback);
        return localVarCall;
     ...
     */
    public UserProfile userGetUserProfile() throws ApiException {
        ApiResponse<UserProfile> localVarResp = userGetUserProfileWithHttpInfo();
     ...
     */
    public ApiResponse<UserProfile> userGetUserProfileWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = userGetUserProfileValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call userGetUserProfileAsync(final ApiCallback<UserProfile> _callback) throws ApiException {

        okhttp3.Call localVarCall = userGetUserProfileValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<UserProfile>(){}.getType();
